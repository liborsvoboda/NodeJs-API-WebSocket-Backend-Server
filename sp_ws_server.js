...
const db = require('./sp_api_models/ws_db');


const cfg = JSON.parse(fs.readFileSync(path.join('./sp_config/ws_config.json'), 'utf8'));
const schemas = JSON.parse(fs.readFileSync(path.join('./sp_api_schemas/ws_schemas.json'), 'utf8'));
const messages = JSON.parse(fs.readFileSync(path.join('./sp_api_messages/ws_messages.json'), 'utf8'));
